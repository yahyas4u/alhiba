...
<script type="text/javascript">
    ...
    var customer_id = [];
    var user_verified = <?php echo e(env('USER_VERIFIED')); ?>;
            ...
            },
            {
                ...
                action: function ( e, dt, node, config ) {
                    if(user_verified == '1') {
                        ...
                        alert('This feature is disable for demooo!');
                }
            },
            {
                extend: 'colvis',
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/alhiba/resources/views/customer/index.blade.php ENDPATH**/ ?>