        ...
        <ul id="side-main-menu" class="side-menu list-unstyled">                  
          ...
          <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span><?php echo e(trans('file.settings')); ?></span></a>
            <ul id="setting" class="collapse list-unstyled ">
              ...
              <li id="brand-menu"><a href="<?php echo e(route('brand.index')); ?>">Collection</a></li>
              <?php endif; ?>
            ...
            <div class="col-md-6">
                <div class="card">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group pos">
                                                ...
                                                <select required name="customer_id" id="customer_id" class="selectpicker form-control open-EditCategoryDialog" data-live-search="true"  title="Select customer..." style="width: 100px" data-toggle="modal" data-target="#showCustomer">
												...
												<button type="button" class="btn btn-default btn-sm" onclick='goToPage(event)'>Edit</button>
                                                <?php else: ?>
                                                <?php $deposit = [] ?>
                    ...
                    <div class="payment-options">
						...
						<!--<div class="column-5">
							<button style="background: #F9D203" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-order" id="cash-btn"><i class="fa fa-money"></i> Rent </button>
                        ...
                        <div class="column-5">
                            <button style="background-color: #ffc107;" type="button" class="btn btn-custom" data-toggle="modal" data-target="#recentTransaction"><i class="dripicons-clock"></i> Sale Transaction</button>
                        </div>
						 <div class="column-5">
                            <button style="background-color: #00A11C;" type="button" class="btn btn-custom" data-toggle="modal" data-target="#recentOrders"><i class="dripicons-clock"></i> Order List</button>
                        </div>
						<div class="column-5">
...
<!-- Edit customer -->
<div id="showCustomer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 id="exampleModalLabel" class="modal-title">Customer Details</h5>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">   
			<button id="print-btn1" type="button" class="btn btn-default btn-sm"><i class="fa fa-print"></i> <?php echo e(trans('file.Print')); ?></button>
          </div>
        </div>
    </div>
  </div>
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mt-1">
											...
											<p id="paid_amount" class="ml-2">0.000</p>
                                            <input type="hidden" name="paid_amount" class="form-control numkey" step="any">
                                        </div>
                                        <div class="col-md-3 mt-1">
                                            <label><?php echo e(trans('file.Change')); ?> : </label>
                                            <p id="change" class="ml-2">0.000</p>
                                        </div>
										<div class="col-md-6 mt-1">
                                            <label>Advance Payment: </label>
                                            <input type="text" name="advance_amount" class="form-control numkey"  step="any">
                                        </div>
									    <div class="col-md-6">
                                            <label>Delivery Date</label>
                                            <input type="date" name="delivery_date" class="form-control numkey"  step="any">
                                        </div>
                                        <div class="col-md-3 mt-1">
            ...
            <div class="col-md-6">
                ...
                <div class="filter-window">
                    ...
                    <div class="brand mt-3">
                        <div class="row ml-2 mr-2 px-2">
                            <div class="col-7">Choose Collection</div>
                            <div class="col-5 text-right">
                                <span class="btn btn-default btn-sm">
                                    <i class="dripicons-cross"></i>
                                </span>
    			...
    			<div class="row">
                    ...
                    <div class="col-md-4">
                        <button class="btn btn-block btn-info" id="brand-filter">Collection</button>
                    </div>
                    <div class="col-md-4">
...
<!-- Add Measurement-->
				<div class="modal-content">          
                    <div class="modal-header">
                      <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('Add Measurement')); ?></h5>
                      <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
                    <div class="modal-body">
                      <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
						 ...
						 <div class="row">
                                <div class="col-md-10">
                                    <div class="row">
										...
										<div class="form-group col-md-3 mt-1">
											<label>Waist </label>
											<input type="text" name="measure_11"  class="form-control">
									   </div>
										<div class="form-group col-md-3 mt-1">
                                ...
                                <div class="col-md-10">
                                    <div class="row">
										<div class="form-group col-md-3 mt-1">
											...
											<input type="text" name="measure_13"  class="form-control">
										</div>
										<div class="form-group col-md-3 mt-1">
											<label>First Hips/Second Hips </label>
											<input type="text" name="measure_14"  class="form-control">
										</div>
										<div class="form-group col-md-3 mt-1">
											<label>Empire</label>
									    	<input type="text" name="measure_15"  class="form-control">
									   </div>
										<div class="form-group col-md-3 mt-1">
											<label>Blouse Length</label>
									    	<input type="text" name="measure_16"  class="form-control">
									   </div>
						 ...
						 <div class="row">
                                <div class="col-md-10">
                                    <div class="row">
										<div class="form-group col-md-3 mt-1">
											...
											<input type="text" name="measure_17"  class="form-control">
										</div>
										<div class="form-group col-md-3 mt-1">
											<label>Croach </label>
                                ...
                                <div class="form-group col-md-10">
								 ...
								 <div class="form-group col-md-12">
									<label>Notes: </label>
									<textarea id="measure_notes" rows="2" class="form-control" name="measure_notes"></textarea>
								</div>
								</div>
						       </div>
							<!--<div class="col-md-6"><img src="<?php echo e(url('public/img','BodyMeasurement.jpg')); ?>" height="750" width="300"></div>-->
						</div>
                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <div class="btn-group">
											<a href="<?php echo e(route('sale.invoice', $sale->id)); ?>" class="btn btn-success btn-sm" title="Print"><i class="dripicons-document-new"></i></a>&nbsp;
	...
	<!-- recent Order modal -->
            <div id="recentOrders" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 id="exampleModalLabel" class="modal-title">Recent Orders <div class="badge badge-primary"><?php echo e(trans('file.latest')); ?> 10</div></h5>
                      <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
                    <div class="modal-body">
                        <ul class="nav nav-tabs" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" href="#sale-latest" role="tab" data-toggle="tab">Order List</a>
                          </li>
                        </ul>
                        <div class="tab-content">
                          <div role="tabpanel" class="tab-pane show active" id="sale-latest">
                              <div class="table-responsive">
                                <table class="table">
                                  ...
                                  <tbody>
                                    <?php $__currentLoopData = $recent_order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $customer = DB::table('customers')->find($sale->customer_id); ?>
                                    <tr>
                                      <td><?php echo e(date('d-m-Y', strtotime($sale->created_at))); ?></td>
									  <td><?php echo e(date('d-m-Y', strtotime($sale->delivery_date))); ?></td>
                                      <td><?php echo e($sale->id); ?></td>
                                      <td><?php echo e($customer->name); ?></td>
									  <td><?php echo e($sale->advance_amount); ?></td>
                                      <td><?php echo e($sale->grand_total); ?></td>
                                      <td>
                                        <div class="btn-group">
											<a href="<?php echo e(route('sale.invoice', $sale->id)); ?>" class="btn btn-success btn-sm" title="Print"><i class="dripicons-document-new"></i></a>&nbsp;
...
function goToPage(event) {
	...
	if(id==11)
		return;
    window.location=url.concat(id).concat("/edit");
}
	
$(document).on("change", ".open-EditCategoryDialog", function(){
		  var customer_name = [];
		  var phone_number = [];
          ...
          var url ="customer/";
          var id = document.getElementById('customer_id').value;
          url = url.concat(id).concat("/showMeasure");
		  if(id==11){
			  	console.log(id)
          ...
          $.get(url, function(data){			   
			customer_name.push(data['name']);
			phone_number.push(data['phone_number']);
			measure_1.push(data['measure_1']);
			measure_2.push(data['measure_2']);
			measure_3.push(data['measure_3']);
			measure_4.push(data['measure_4']);
			measure_5.push(data['measure_5']);
...
$("#print-btn1").on("click", function(){
          var divToPrint=document.getElementById('showCustomer');
          var newWin=window.open('','Print-Window');
          newWin.document.open();
          newWin.document.write('<style type="text/css">@media  print { #modal_header { display: none } #print-btn1 { display: none } #close-btn { display: none } } table.barcodelist { page-break-inside:auto } table.barcodelist tr { height:25px; width: 38px; page-break-inside:avoid; page-break-after:auto }</style><body onload="window.print()">'+divToPrint.innerHTML+'</body>');
...
$('.brand-img').on('click', function(){
    ...
    $(".table-container").children().remove();
    $.get('sales/getproduct/' + category_id + '/' + brand_id, function(data) {
		//alert('sales/getproduct/' + category_id + '/' + brand_id);
        populateProduct(data);
    });
});
...
$(".payment-btn").on("click", function() {
    ...
    $('.qc').data('initial', 1);
	$("#paid_amount").text( parseFloat($("#grand-total").text()).toFixed(3) );
});
...
$("#submit-rent-btn").on("click", function() {
    $('.payment-form').submit();
});
...
/*$('#add-payment').on("click", function() {
	...
	if(document.getElementById('customer_id').value==11){
		$('deposit_amount_show').hide();
	}
});*/
...
<?php echo $__env->make('layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/alhiba/resources/views/sale/pos.blade.php ENDPATH**/ ?>