                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="net_unit_price"><?php echo e(number_format((float)$product_sale->net_unit_price, 3, '.', '')); ?> </td>
                                                        <td class="discount"><?php echo e(number_format((float)$product_sale->discount, 3, '.', '')); ?></td>
                                                        <td class="tax"><?php echo e(number_format((float)$product_sale->tax, 3, '.', '')); ?></td>
                                                        <td class="sub-total"><?php echo e(number_format((float)$product_sale->total, 3, '.', '')); ?></td>
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th></th>
                                                    <th id="total-discount"><?php echo e(number_format((float)$lims_sale_data->total_discount, 3, '.', '')); ?></th>
                                                    <th id="total-tax"><?php echo e(number_format((float)$lims_sale_data->total_tax, 3, '.', '')); ?></th>
                                                    <th id="total"><?php echo e(number_format((float)$lims_sale_data->total_price, 3, '.', '')); ?></th>
                                                    <th><i class="dripicons-trash"></i></th>
                                                </tfoot>
                                            </table>
                                        </div>
								 ...
								 <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                           ...
                                           <input type="text" name="advance_amount" class="form-control" disabled value="<?php echo e($lims_sale_data->advance_amount); ?>">
											 <input type="hidden" name="advance_amount"  value="<?php echo e($lims_sale_data->advance_amount); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Balance amount</label>
                                            <input type="text" name="balance_amount" class="form-control" value="<?php echo e(number_format((float)$lims_sale_data->grand_total-$lims_sale_data->advance_amount, 3, '.', '')); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/alhiba/resources/views/sale/edit.blade.php ENDPATH**/ ?>