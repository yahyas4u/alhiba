...
<div style="max-width:400px;margin:0 auto">
	...
	@else
		<table>
			 <tbody>
				 <tr>
                      <th align="left">{{trans('file.Total')}}:</th>
					  <th> OMR {{number_format((float)$lims_sale_data->total_price, 3, '.', '')}}</th>
					  <th align="right"> :اجمالي </th>
				  </tr>
				  <tr>
				    <th align="left">Total VAT</th>
				  ...
				  <tr>
                      <th align="left">Grand Total:</th>
					  <th>OMR {{number_format((float)$lims_sale_data->grand_total, 3, '.', '')}}</th>
					  <th align="right"> :اجمالي المبلغ</th>
				  </tr>
				 <tr>
                      <th align="left">Advance Amount:</th>
					  <th>OMR {{number_format((float)$lims_sale_data->advance_amount, 3, '.', '')}}</th>
					  <th align="right">مبلغ المقدم</th>
				  </tr>
				 <tr>
                      <th align="left">Delivery Date:</th>
					  <th>{{$lims_sale_data->delivery_date}}</th>
					  <th align="right"> :تاريخ التسليم </th>
				  </tr>
				  <tr>
                      <th align="left">Balance Amount:</th>
					 <th>{{number_format((float)$lims_sale_data->grand_total-$lims_sale_data->advance_amount, 3, '.', '')}}</th>
	...
	@endif
		...
		<table>
            <tbody>
				<tr><td class="centered" colspan="3">شكر لحسن زيارتكم لنا</br>{{trans('file.Thank you for shopping with us')}}</td></tr>
