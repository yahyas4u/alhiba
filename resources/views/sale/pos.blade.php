        ...
        <ul id="side-main-menu" class="side-menu list-unstyled">                  
          ...
          <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>{{trans('file.settings')}}</span></a>
            <ul id="setting" class="collapse list-unstyled ">
              ...
              <li id="brand-menu"><a href="{{route('brand.index')}}">Collection</a></li>
              @endif
  ...
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">   
			<button id="print-btn1" type="button" class="btn btn-default btn-sm"><i class="fa fa-print"></i> {{trans('file.Print')}}</button>
          </div>
        </div>
    </div>
  </div>
...
<!-- Add Measurement-->
				<div class="modal-content">          
                    <div class="modal-header">
                      <h5 id="exampleModalLabel" class="modal-title">{{trans('Add Measurement')}}</h5>
                      <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
                    <div class="modal-body">
                      <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
						 ...
						 <div class="row">
							...
							<!--<div class="col-md-6"><img src="{{url('public/img','BodyMeasurement.jpg')}}" height="750" width="300"></div>-->
						</div>
                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <div class="btn-group">
											<a href="{{ route('sale.invoice', $sale->id) }}" class="btn btn-success btn-sm" title="Print"><i class="dripicons-document-new"></i></a>&nbsp;
	...
	<!-- recent Order modal -->
            <div id="recentOrders" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 id="exampleModalLabel" class="modal-title">Recent Orders <div class="badge badge-primary">{{trans('file.latest')}} 10</div></h5>
                      <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
                    <div class="modal-body">
                        <ul class="nav nav-tabs" role="tablist">
