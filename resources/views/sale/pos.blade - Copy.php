                ...
                <div class="card">
                    ...
                    <div class="payment-options">
                        ...
                        <div class="column-5">
						 ...
						 <div class="column-5">
                            <button style="background-color: #00A11C;" type="button" class="btn btn-custom" data-toggle="modal" data-target="#recentTransaction"><i class="dripicons-clock"></i> Recent Orders</button>
                        </div>
						<div class="column-5">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="row">
										...
										<div class="col-md-3 mt-1" id="deposit_amount_show">
                                            <label>Deposit Amount</label>
                                             <input type="text" name="deposit_amount" class="form-control numkey"  step="any">
                                        </div>
                                        <div class="col-md-3 mt-1">
										...
										<div class="col-md-6">
                                            ...
                                            <input type="date" name="delivery_date" value="Select date" class="form-control">
                                        </div>
										<div class="form-group col-md-6">
											 <label>Returning Date</label>
                                            <input type="date" name="return_date" value="Select date" class="form-control">
										</div>
